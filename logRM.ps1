function LogRM {
      ...
      if($ip -match '127.0.0.1')
      {
        ...
        if($eventID -eq "")
        {
            $events=(4624,4625,4634,4647,4648,4728,4729,4732,4733,4738,4756,4757,4776,4688,5136,400,600,500,501)
...
function logQuery($eventID,$newest)
{
    ...
    if($using:eventID -eq 4624)
    {
		...
		Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4624 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name="Username";Expression={$_.ReplacementStrings[5]}},@{Name="SourceIP";Expression={$_.ReplacementStrings[18]}},@{Name="SourcePort";Expression={$_.ReplacementStrings[19]}}
    ...
    elseif($using:eventID -eq 4625)
    {
		...
		Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4625 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name="Username";Expression={$_.ReplacementStrings[5]}},@{Name="SourceIP";Expression={$_.ReplacementStrings[19]}},@{Name="SourcePort";Expression={$_.ReplacementStrings[20]}}
	...
	elseif($using:eventID -eq 4634)
	{
		...
		Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4634 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name="Username";Expression={$_.ReplacementStrings[1]}},@{Name="Security ID";Expression={$_.ReplacementStrings[0]}}

	}
	elseif($using:eventID -eq 4720)
	{
		Write-Host "[+] " -ForegroundColor Green -Nonewline; Write-Output "Information EventID (4720) - A user account was created"
		#Get-EventLog -Newest $newest -LogName Security -Instanceid 4720 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name="Created Account Name";Expression={$_.ReplacementStrings[0]}},@{Name="Created Account Domain";Expression={$_.ReplacementStrings[1]}},@{Name="Created Account SID";Expression={$_.ReplacementStrings[2]}},@{Name="Account SID Performed Changes";Expression={$_.ReplacementStrings[3]}},@{Name="Account Name Performed Changes";Expression={$_.ReplacementStrings[4]}},@{Name="Account Domain Performed Changes";Expression={$_.ReplacementStrings[5]}},@{Name="Account Logon ID Performed Changes";Expression={$_.ReplacementStrings[6]}},@{Name="SAM Account Name";Expression={$_.ReplacementStrings[8]}},@{Name="Display Name";Expression={$_.ReplacementStrings[9]}},@{Name="User Principal Name";Expression={$_.ReplacementStrings[10]}},@{Name="Primary Group ID";Expression={$_.ReplacementStrings[18]}}
        Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4720 | Select -Property TimeGenerated,MachineName,@{Name="Created Account Name";Expression={$_.ReplacementStrings[0]}},@{Name="Created Account Domain";Expression={$_.ReplacementStrings[1]}},@{Name="Created Account SID";Expression={$_.ReplacementStrings[2]}},@{Name="Account SID Performed Changes";Expression={$_.ReplacementStrings[3]}},@{Name="Account Name Performed Changes";Expression={$_.ReplacementStrings[4]}},@{Name="Account Domain Performed Changes";Expression={$_.ReplacementStrings[5]}},@{Name="Account Logon ID Performed Changes";Expression={$_.ReplacementStrings[6]}},@{Name="SAM Account Name";Expression={$_.ReplacementStrings[8]}},@{Name="Display Name";Expression={$_.ReplacementStrings[9]}},@{Name="User Principal Name";Expression={$_.ReplacementStrings[10]}},@{Name="Primary Group ID";Expression={$_.ReplacementStrings[18]}}
    ...
    elseif($using:eventID -eq 4738)
	{
		...
		#Get-EventLog -Newest $newest -LogName Security -Instanceid 4738 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name="Changed Account Name";Expression={$_.ReplacementStrings[1]}},@{Name="Changed Account Domain";Expression={$_.ReplacementStrings[2]}},@{Name="Changed Account SID";Expression={$_.ReplacementStrings[3]}},@{Name="Account SID Performed Changes";Expression={$_.ReplacementStrings[4]}},@{Name="Account Name Performed Changes";Expression={$_.ReplacementStrings[5]}},@{Name="Account Domain Performed Changes";Expression={$_.ReplacementStrings[6]}},@{Name="Account Logon ID Performed Changes";Expression={$_.ReplacementStrings[7]}},@{Name="SAM Account Name";Expression={$_.ReplacementStrings[9]}},@{Name="Display Name";Expression={$_.ReplacementStrings[10]}},@{Name="User Principal Name";Expression={$_.ReplacementStrings[11]}},@{Name="Primary Group ID";Expression={$_.ReplacementStrings[19]}}
        Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4738 | Select -Property TimeGenerated,MachineName,@{Name="Changed Account Name";Expression={$_.ReplacementStrings[1]}},@{Name="Changed Account Domain";Expression={$_.ReplacementStrings[2]}},@{Name="Changed Account SID";Expression={$_.ReplacementStrings[3]}},@{Name="Account SID Performed Changes";Expression={$_.ReplacementStrings[4]}},@{Name="Account Name Performed Changes";Expression={$_.ReplacementStrings[5]}},@{Name="Account Domain Performed Changes";Expression={$_.ReplacementStrings[6]}},@{Name="Account Logon ID Performed Changes";Expression={$_.ReplacementStrings[7]}},@{Name="SAM Account Name";Expression={$_.ReplacementStrings[9]}},@{Name="Display Name";Expression={$_.ReplacementStrings[10]}},@{Name="User Principal Name";Expression={$_.ReplacementStrings[11]}},@{Name="Primary Group ID";Expression={$_.ReplacementStrings[19]}}
    ...
    elseif($using:eventID -eq 4647)
    {
        ...
        Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4647 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name="Username";Expression={$_.ReplacementStrings[1]}}
    }
    elseif($using:eventID -eq 4648)
    {
        Write-Host "[+] " -ForegroundColor Green -Nonewline; Write-Output "Information EventID (4648) - A logon was attempted using explicit credentials"
        #Get-EventLog -Newest $newest -LogName Security -Instanceid 4648 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name= "Original Account SID";Expression={$_.ReplacementStrings[0]}},@{Name="Original Account Name";Expression={$_.ReplacementStrings[1]}},@{Name="Original Account Domain";Expression={$_.ReplacementStrings[2]}},@{Name="Original Account Logon ID";Expression={$_.ReplacementStrings[3]}},@{Name="RunAs Account Name";Expression={$_.ReplacementStrings[5]}},@{Name="RunAs Account Domain";Expression={$_.ReplacementStrings[6]}},@{Name="Target Server Name";Expression={$_.ReplacementStrings[8]}},@{Name="Additional Information";Expression={$_.ReplacementStrings[9]}},@{Name="Process  ID";Expression={$_.ReplacementStrings[10]}},@{Name="Process Name";Expression={$_.ReplacementStrings[11]}},@{Name="Network Address";Expression={$_.ReplacementStrings[12]}},@{Name="Network"; Expression={$_.ReplacementStrings[13]}}
        Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4648 | Select -Property TimeGenerated,MachineName,@{Name= "Original Account SID";Expression={$_.ReplacementStrings[0]}},@{Name="Original Account Name";Expression={$_.ReplacementStrings[1]}},@{Name="Original Account Domain";Expression={$_.ReplacementStrings[2]}},@{Name="Original Account Logon ID";Expression={$_.ReplacementStrings[3]}},@{Name="RunAs Account Name";Expression={$_.ReplacementStrings[5]}},@{Name="RunAs Account Domain";Expression={$_.ReplacementStrings[6]}},@{Name="Target Server Name";Expression={$_.ReplacementStrings[8]}},@{Name="Additional Information";Expression={$_.ReplacementStrings[9]}},@{Name="Process  ID";Expression={$_.ReplacementStrings[10]}},@{Name="Process Name";Expression={$_.ReplacementStrings[11]}},@{Name="Network Address";Expression={$_.ReplacementStrings[12]}},@{Name="Network"; Expression={$_.ReplacementStrings[13]}}
    }
    ...
    elseif($using:eventID -eq 4688)
    {
        ...
        Get-EventLog -Newest $using:newest -LogName Security -Instanceid 4688 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property index,TimeGenerated,MachineName,@{Name="Creator SID";Expression={$_.ReplacementStrings[0]}},@{Name="Creator Account Name";Expression={$_.ReplacementStrings[1]}},@{Name="Target SID";Expression={$_.ReplacementStrings[9]}},@{Name="Target Account Name";Expression={$_.ReplacementStrings[10]}},@{Name="Target Account Domain";Expression={$_.ReplacementStrings[11]}},@{Name="Token Elevation Type";Expression={if($_.ReplacementStrings[6] -eq "%%1936"){ "full token - User Account Control is disabled" }elseif($_.ReplacementStrings[6] -eq "%%1937"){ "elevated token - User Account Control is enabled, program executed Run as administrator" }else{ "normal value - UAC is enabled, user starts a program from the Start Menu" }}},@{Name="Creator Process Name";Expression={$_.ReplacementStrings[13]}},@{Name="New Process Name";Expression={$_.ReplacementStrings[5]}}
    }
	elseif($using:eventID -eq 5136)
	{
		Write-Host "[+] " -ForegroundColor Green -Nonewline; Write-Output "Information EventID (5136) - A Directory Process Object was Modified"
		Get-EventLog -Newest $using:newest -LogName Security -Instanceid 5136 | Where {$_.message -notmatch "Account Name:\s*\w+\$"} | Select -Property TimeGenerated,MachineName,@{Name="AccountToObject";Expression={$_.ReplacementStrings[3]}},@{Name="SID";Expression={$_.ReplacementStrings[2]}},@{Name="Object";Expression={$_.ReplacementStrings[8]}},@{Name="ObjectGUID";Expression={$_.ReplacementStrings[9]}},@{Name="Class";Expression={$_.ReplacementStrings[10]}},@{Name="Type";Expression={$_.ReplacementStrings[14]}},@{Name="LDAP Display Name";Expression={$_.ReplacementStrings[11]}},@{Name="LDAP Value";Expression={$_.ReplacementStrings[13]}}
	}
    ...
    else <# Executing all event logs if the user doesn't specify one #>
    {
        ...
        foreach($event500_501 in $event500_501_array)
        {
            ...
            try
            {
                $get500_501=Get-EventLog -Newest $newest -InstanceId $event500_501 -LogName "Windows Powershell" | select TimeGenerated,PSComputerName,@{Name="Command";Expression={$_.ReplacementStrings[2]}} | select TimeGenerated,PSComputerName,Command
                if(($get500_501 | Measure-Object).count -gt 0)
                {
                    $timeGenerated=($get500_501 | Select TimeGenerated)
                    #$psComputerName=$get500_501.PsComputerName
...
#Get ObjectGUID
#Example->Get-ADObject -Identity D4429A86-CE1E-48E3-8CFF-E391397DA168

#Translate Security Descruptitor to Human visible
